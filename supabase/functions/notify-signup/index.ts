  ...
  try {
    ...
    const html = `
      <div style="font-family:sans-serif;max-width:500px;margin:0 auto;padding:24px;">
        ...
        <a href="https://agentforge-academy.vercel.app/admin" style="display:inline-block;margin-top:16px;background:#0067B8;color:#fff;padding:10px 20px;border-radius:8px;text-decoration:none;font-weight:600;">
    ...
    if (RESEND_API_KEY) {
      await fetch('https://api.resend.com/emails', {
        ...
        body: JSON.stringify({
          from: 'Social Dev Technologies <notifications@socialdevtech.com>',
          to: [ADMIN_EMAIL],
