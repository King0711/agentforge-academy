...
export const webinarSlides = [
  ...
  },
  {
    ...
    notes: {
      ...
      transition: "Don't just take my word for it — here's what real builders are already saying.",
    },
  },
  {
    id: 'social-proof',
    label: 'Real builders',
    notes: {
      objective: 'Let other people\'s words do the persuading — this is trust-building, not selling.',
      talkingPoints: [
        'Don\'t over-narrate — let 2-3 testimonials sit on screen, read one out loud verbatim',
        'Point out the "Verified Builder" tag — real completions, not paid actors',
      ],
      story: 'If you have screenshots, LinkedIn posts, or portfolio examples ready to share, this is the moment — bring them up outside the deck if you have them.',
      interactionPrompt: 'Chat: "If any of this sounds like where you are right now, drop a 🙋."',
  ...
  },
  {
    ...
    notes: {
      ...
      transition: "With that out of the way — here's exactly what Builder 1 includes.",
    },
  },
  {
    id: 'the-offer',
